$(function () {
    ...
    $("table").DataTable({
        "dom":
            '<"row"<"col-sm-12 col-md-4 text-left"l>><"row"<"col-sm-12 col-md-7"B><"col-sm-12 col-md-5 text-right"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"p>>',
        "scrollY": "50vh",
        "scrollX": true,
        "scrollCollapse": true,
        "paging": false,
